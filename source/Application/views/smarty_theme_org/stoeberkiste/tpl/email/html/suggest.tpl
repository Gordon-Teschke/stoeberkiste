              ...
              <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-top : 10px; padding-bottom : 10px; padding-left : 10px;  padding-right : 10px;">
                  <tr>
                    ...
                    <td bgcolor="#ffffff" align="right"><img src="http://stoeberkiste-wuppertal.de/out/stoeberkiste/img/email-logo.jpg" border="0" hspace="0" vspace="0" alt="[{ $shop->oxshops__oxname->value }]" align="texttop"></td>
                  </tr>
                </table>
              </td>
            </tr>
