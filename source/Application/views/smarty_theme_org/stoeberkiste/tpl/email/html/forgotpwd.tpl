...
<html>
  ...
  <body bgcolor="#ffffff"  link="#355222" alink="#355222" vlink="#355222" style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif; font-size: 10px;">
    <br>
    <img src="http://stoeberkiste-wuppertal.de/out/stoeberkiste/img/email-logo.jpg" border="0" hspace="0" vspace="0" alt="[{ $shop->oxshops__oxname->value }]" align="texttop"><br><br>
