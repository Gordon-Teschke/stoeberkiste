...
<html[{if $oView->getActiveLangAbbr()}] lang="[{ $oView->getActiveLangAbbr() }]"[{/if}] [{if $oViewConf->getFbAppId()}]xmlns:fb="https://www.facebook.com/2008/fbml"[{/if}]>
<head>
...
<div id="page">
    ...
    <div id="header">
        <div class="bar oxid">
            ...
            [{if $oViewConf->getViewThemeParam('bl_perfShowTopBasket')}]
        ...
        <div class="bar links[{if !$oViewConf->getViewThemeParam('blTopNaviLayout')}] single[{/if}]">
            <div class="fixed">
