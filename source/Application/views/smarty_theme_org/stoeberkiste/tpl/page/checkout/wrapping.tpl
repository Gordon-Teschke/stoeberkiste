...
[{include file="_header.tpl" title=$template_title location="WRAPPING_LOCATION"|oxmultilangassign seopage="checkout"}]
...
<div class="" style="">
  ...
  <h1 class="boxhead wrapptop">[{ oxmultilang ident="WRAPPING_ADDWRAPPING" }]</h1>
  ...
  <div class="box info">
      <table>
        <tr>
          ...
          <td>
              <span class="fs12"><b>Soll es ein Geschenk sein? D&uuml;rfen wir es f&uuml;r Sie verpacken?<br />
Das geh&ouml;rt zum Service, wir machen es sehr gerne und besonders liebevoll und es kostet keinen Cent extra.

Sie setzen den entsprechenden Haken, wir binden die Schleife.</b></span><br>
