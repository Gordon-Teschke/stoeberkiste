...
<!-- yyy -->
    ...
    <strong class="boxhead"><br /><br />[{ oxmultilang ident="ORDER_SEND" }]</strong>
    <div class="box info">

      <dl id="test_orderBillAdress" class="orderinfocol">
        <dt><b>[{ oxmultilang ident="ORDER_BILLINGADDRESS" }]</b></dt>
            ...
            <form action="[{ $oViewConf->getSslSelfLink() }]" method="post">
              <div>
				  ...
				  <div class="btn-made-left">
                  <span class="btn1"><input id="test_orderChangeBillAdress" type="submit" value="[{ oxmultilang ident="ORDER_MODIFYADDRESS2" }]" class="btn"></span>
				  </div>
              </div>
            </form>
            <br>
        ...
        <dt>[{ oxmultilang ident="ORDER_SHIPPINGADDRESS" }]</dt>
            ...
            <form action="[{ $oViewConf->getSslSelfLink() }]" method="post">
              <div>
                  ...
                  <input type="hidden" name="fnc" value="">
				  <div class="btn-made-left">
                  <span class="btn1"><input id="test_orderChangeShipAdress" type="submit" value="[{ oxmultilang ident="ORDER_MODIFYADDRESS2" }]" class="btn"></span>
				  </div>
              </div>
            </form>
            <br>
        ...
        <dt>[{ oxmultilang ident="ORDER_SHIPPINGCARRIER" }]</dt>
            ...
            <form action="[{ $oViewConf->getSslSelfLink() }]" method="post">
              <div  id="test_orderShipping">
				  ...
				  <div class="btn-made-left">
                  [{ $oShipSet->oxdeliveryset__oxtitle->value }]&nbsp;<span class="btn1"><input id="test_orderChangeShipping" type="submit" value="[{ oxmultilang ident="ORDER_MODIFY3" }]" class="btn"></span>
				  </div>
              </div>
            </form>
        ...
        <dt>[{ oxmultilang ident="ORDER_PAYMENTMETHOD" }]</dt>
            ...
            <form action="[{ $oViewConf->getSslSelfLink() }]" method="post">
              <div  id="test_orderPayment">
				  ...
				  <div class="btn-made-left">
                  [{ $payment->oxpayments__oxdesc->value }]&nbsp;<span class="btn1"><input id="test_orderChangePayment" type="submit" value="[{ oxmultilang ident="ORDER_MODIFY2" }]" class="btn"></span>
				  </div>
              </div>
            </form>
  ...
  <table class="basket" width="569">
      ...
      <thead style="background:#f1f1f1;">
        <tr>
            ...
            <th class="" align="left">[{ oxmultilang ident="ORDER_UNITPRICE" }]</th>
            <th class="" align="left">[{ oxmultilang ident="ORDER_QUANTITY" }]</th>
            <th class="" align="left">[{ oxmultilang ident="ORDER_TAX" }]</th>
            <th class="" align="left">[{ oxmultilang ident="ORDER_TOTAL" }]</th>
            <th class="lastcol"></th>
        </tr>
      </thead>
          ...
          <div class="bar prevnext terms">
            <form action="[{ $oViewConf->getSslSelfLink() }]" method="post">
              <div>
                  ...
                  <input type="hidden" name="sDeliveryAddressMD5" value="[{$oView->getDeliveryAddressMD5()}]">
                  <div class="right arrowright">
                      <input class="btn" id="test_OrderSubmitBottom" type="submit" value="[{ oxmultilang ident="ORDER_SUBMITORDER" }]">
                  </div>
