...
[{include file="_header.tpl" title=$template_title location="THANKYOU_LOCATION"|oxmultilangassign seopage="checkout"}]
...
[{assign var="basket" value=$oView->getBasket()}]
  ...
  <div class="box info">
    <div class="thanks-a-lot">
        Vielen Dank f&uuml;r Ihre Bestellung bei der St&ouml;berkiste. <br>
        ...
        <a id="test_BackToShop" rel="nofollow" href="[{ oxgetseourl ident=$oViewConf->getHomeLink() }]" class="btn" style="font-family:'Lato';font-size:16px;margin-bottom:26px;"><b>Zur Startseite</b>.</a><br>
    </div>
  </div>
            ...
            <div class="etrustdescocol">
                <form id="formTsShops" name="formTShops" method="post" action="https://www.trustedshops.com/shop/protection.php" target="_blank">
                  <div>
                      ...
                      <span class="btn1"><input type="submit" id="btnProtect" name="btnProtect" class="btn" value="[{ oxmultilang ident="THANKYOU_LOGGIN" }]"></span>
                  </div>
                </form>
            </div>
          </div>
