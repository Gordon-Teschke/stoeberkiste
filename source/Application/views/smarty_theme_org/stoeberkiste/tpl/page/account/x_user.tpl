  ...
  [{include file="inc/error.tpl" Errorlist=$Errors.user errdisplay="inbox"}]
    <form action="[{ $oViewConf->getSelfActionLink() }]" name="order" method="post">
      <div class="account">
          ...
          <tr class="th_sep">
              <th colspan="2" align="left">[{ oxmultilang ident="ACCOUNT_USER_BILLINGADDRESS" }] <small>[{ oxmultilang ident="ACCOUNT_USER_COMPLETEMARKEDFIELDS" }]</small></th>
          </tr>
          <tr>
          ...
          <tr>
            <td class="form-input"><label>[{ oxmultilang ident="ACCOUNT_USER_ADDITIONALINFO" }]</label></td>
            <td class="form-input">
          ...
          <tr class="td_sep">
            <td colspan="2" align="right">
              <input id="test_accUserSaveTop" type="submit" name="save" class="btn" value="[{ oxmultilang ident="ACCOUNT_USER_SAVE" }]">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <select class="form-country" name="oxaddressid" onchange="oxid.form.set('reloadAddress', this.value === '-1' ? 1 : 2);oxid.form.reload(this.value === '-1','order','account_user','');oxid.form.clear(this.value !== '-1','order',/oxaddress__/);">
          ...
          <tr>
            ...
            <td>
              <input class="input-short-left" type="text" size="5" maxlength="50" name="deladr[oxaddress__oxzip]" value="[{if isset( $deladr.oxaddress__oxzip ) }][{ $deladr.oxaddress__oxzip }][{else}][{ $delivadr->oxaddress__oxzip->value }][{/if }]">
          ...
          <tr>
            <td colspan="2" align="right">
             ...
             <input id="test_accUserSaveBottom" type="submit" class="btn" name="save" value="[{ oxmultilang ident="ACCOUNT_USER_SAVE2" }]">
            </td>
          </tr>
        </table>
      </div>
