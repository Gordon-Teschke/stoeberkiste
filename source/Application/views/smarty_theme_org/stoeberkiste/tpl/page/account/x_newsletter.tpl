    ...
    [{else }]
        <form action="[{ $oViewConf->getSelfActionLink() }]" name="newsletter" method="post">
          <div>
              ...
              <select class="form-newsletter" name="status">
              ...
              <small>[{ oxmultilang ident="ACCOUNT_NEWSLETTER_MESSAGE" }]</small>
              <div class="dot_sep"></div>
              <div class="newsletter-submit">
                <input id="test_newsletterSettingsSave" type="submit" value="[{ oxmultilang ident="ACCOUNT_NEWSLETTER_SAVE" }]" class="btn">
              </div>
              <br><br>
          </div>
        </form>
