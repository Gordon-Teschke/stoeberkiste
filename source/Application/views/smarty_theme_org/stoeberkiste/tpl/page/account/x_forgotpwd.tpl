  ...
  <div class="box info">
    ...
    <form action="[{ $oViewConf->getSelfActionLink() }]" name="order" method="post">
      ...
      <table class="form">
          ...
          <tr>
            <td></td>
            <td><span class="btn1"><input type="submit" name="save" value="[{ oxmultilang ident="FORGOTPWD_UPDATEPASSWORD" }]" class="btn"></span></td>
          </tr>
      </table>
    </form>
  </div>
    ...
    <div class="box info">
      ...
      <form action="[{ $oViewConf->getSelfActionLink() }]" name="order" method="post">
        ...
        <table class="form">
          ...
          <tr>
            <td></td>
            <td><span class="btn1"><input type="submit" name="save" value="[{ oxmultilang ident="FORGOTPWD_REQUESTPWD" }]" class="btn"></span></td>
          </tr>
        </table>
      </form>
