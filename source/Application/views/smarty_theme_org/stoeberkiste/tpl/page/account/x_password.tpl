            ...
            [{include file="inc/error.tpl" Errorlist=$Errors.user errdisplay="inbox"}]
             ...
             <table class="form">
               <tr>
                 ...
                 <td class="form-input"><input type="password" name="password_old"></td>
               </tr>
               <tr>
                 <td><label>[{ oxmultilang ident="ACCOUNT_PASSWORD_NEWPASSWORD" }]</label></td>
                 <td class="form-input"><input type="password" name="password_new"></td>
               </tr>
               <tr>
                 <td><label>[{ oxmultilang ident="ACCOUNT_PASSWORD_CONFIRMPASSWORD" }]&nbsp;&nbsp;&nbsp;</label></td>
                 <td class="form-input"><input type="password" name="password_new_confirm"></td>
               </tr>
             </table>
             <div class="dot_sep"></div>
             <div class="left user-pswd-btn">
               <input id="test_savePass" type="submit" value="[{ oxmultilang ident="ACCOUNT_PASSWORD_SAVE" }]" class="btn">
             </div>
            <br><br>
        </div>
       </form>
