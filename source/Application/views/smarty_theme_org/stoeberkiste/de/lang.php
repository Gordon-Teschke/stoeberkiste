...
'INC_STEPS_ITEM_CHANGEITEMS'                                  => "(Bestellmenge ändern, ausgewählte Artikel entfernen)",
'INC_STEPS_ITEM_LASTSTEP1'                                    => "Fertig",
'INC_STEPS_ITEM_LASTSTEP2'                                    => "(Bestellung ausgeführt)",
'INC_STEPS_ITEM_LOGINSELECTBILLINGINFO'                       => "(Login, Rechnungs- und Lieferadresse wählen)",
'INC_STEPS_ITEM_ORDER'                                        => "Bestellen",
'INC_STEPS_ITEM_SELECTSHIPPINGANDPAYMENT'                     => "(Versandart und Zahlungsart auswählen)",
...
/* Erweiterung */
'ACCOUNT_LOGIN_LOGIN' => 'Einloggen',
'INC_CMP_LOGIN_LOGIN2' => 'Jetzt einloggen',
'INC_CMP_LOGIN_EMAIL' => 'E-Mail',
'INC_CMP_LOGIN_PWD' => 'Kennwort',

'BASKET_REMOVE'                                   		        => "Artikel entfernen",
'BASKET_BASKET' => 'Warenkorb',

'INC_CMP_LOGIN_LOGIN2' => "Jetzt anmelden",
'INC_CMP_LOGIN_EMAIL' => "E-Mail Adresse",
'INC_CMP_LOGIN_PWD' => "Kennwort",

'REGISTER_EMAIL' => "E-Mail Adresse",
'REGISTER_PWD' => "Kennwort",
'REGISTER_TITLE' => "Anrede",
'REGISTER_LASTNAME' => "Nachname",
'REGISTER_NOTE' => "Hinweis",
'REGISTER_ADDRESSES' => "Kennwort",
'REGISTER_TITLE2' => "Anrede",
'REGISTER_PHONE2' => "Telefon",

'INC_STEPS_ITEM_BASKET' => "Warenkorb",

'INC_ACCOUNT_HEADER_MYACCOUNT' => "Mein Account",
'INC_ACCOUNT_HEADER_PRODUCT3' => "Artikel auf Merkliste",
'ACCOUNT_NEWSLETTER_SUBSCRIPTION' => "Newsletter aboniert",
...
'CONTACT_EMAIL2' => "E-Mail Adresse",
'CONTACT_SUBJECT' => "Betreff",
'CONTACT_MESSAGE' => "Nachricht",
'CONTACT_VERIFICATIONCODE' => "Captcha",
...
'ACCOUNT_USER_TITLE2' => "Titel",
'ACCOUNT_USER_PHONE2' => "Telefon",

'ACCOUNT_ORDER_ORDERNO' => "Bestell-Nr.",
'ACCOUNT_ORDER_CART' => "Warenkorb",

'USER_TITLE' => "Anrede",
'USER_PHONE' => "Telefon",
'USER_ADDRESSES' => "Adresse",
"USER_TITLE2" => "Anrede",
"USER_PHONE2" => "Telefon",

'ORDER_ARTICLENOMBER' => 'Artikel-Nr.',
...
'EMAIL_ORDER_OWNER_HTML_PAYMENTINFO' => "Zahlungsinfo",
'EMAIL_ORDER_CUST_HTML_EMAILADDRESS' => "E-Mail",
'EMAIL_ORDER_CUST_HTML_BILLINGADDRESS' => "Rechnungsadresse",
'EMAIL_ORDER_CUST_HTML_PHONE' => "Telefon",

'USER_NOTE' => "Hinweis",
'ORDER_MODIFY' => "Bearbeiten",
'ORDER_EMAIL' => "E-Mail",
'ORDER_PHONE' => "Telefon",
'WRAPPING_ARTNUMBER' => "Art.-Nr.",

'EMAIL_ORDER_CUST_HTML_BANK' => "",
'EMAIL_ORDER_CUST_HTML_ROUTINGNOMBER' => "",
'EMAIL_ORDER_CUST_HTML_ACCOUNTNOMBER' => "",
'BIC' => "",
'IBAN' => "",

'USER_EMAILADDRESS2' => "E-Mail",

'BASKET_ENTERCOUPONNUMBER' => 'Wenn Sie einen Gutscheincode haben, tragen Sie diesen bitte hier ein:',
);